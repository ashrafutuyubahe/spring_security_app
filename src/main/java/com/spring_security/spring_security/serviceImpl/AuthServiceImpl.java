...
public class AuthServiceImpl implements AuthService {
    ...
    // margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;
    // background-color: #f9f9f9;\">"
    // + "<h2 style=\"color: #2a9d8f; text-align: center;\">Password Reset
    // Request</h2>"
    // + "<p style=\"font-size: 16px; color: #333;\">Hello <b>" + userName +
    // "</b>,</p>"
    // + "<p style=\"font-size: 16px; color: #333;\">You have requested to reset
    // your password. Please use the code below to reset your password:</p>"
    // + "<div style=\"background-color: #2a9d8f; padding: 10px; border-radius: 5px;
    // margin: 20px 0; text-align: center;\">"
    // + "<span style=\"color: #fff; font-size: 24px; font-weight: bold;\">" +
    // resetCode + "</span>"
    // + "</div>"
    // + "<p style=\"font-size: 16px; color: #333;\">If you did not request a
    // password reset, please ignore this email.</p>"
    // + "<p style=\"font-size: 16px; color: #333;\">Thank you,<br><b>The Agrovolve
    // Team</b></p>"
